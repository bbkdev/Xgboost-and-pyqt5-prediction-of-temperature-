...
dataset = pd.read_csv("dataSIMULATION.csv", delimiter=';')
...
# linear reg
xgbreg = MultiOutputRegressor(XGBRegressor(n_estimators=1000))
...
class main(QtWidgets.QWidget, Ui_l2):
    ...
    def plott(self):
        ...
        plt.legend(['RADIATION', 'PREDICTION'], loc='down down')
        plt.show()
